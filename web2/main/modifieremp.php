        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Modifier Employe</h3>
                </div>
              ...
              <!-- Row -->
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Modification d'un employe</h4>
                                
                                <form class="form p-t-20" action="modifiere.php" method="post">
									<p>&nbsp;</p>
									<?php
						
				             $req = $bdd->query('SELECT * FROM utilisateur WHERE ID_utilisateur='.$id);

							$donnees = $req->fetch();
							{
							
							?>
								<input type="hidden" name="id" value="<?php echo $donnees["ID_utilisateur"] ; ?> "></p>

                                    <div class="form-group">
                                        <label for="exampleInputuname2">Le nom</label>
                                        <div class="input-group">
                                            <input type="text" name="nom" value="<?php echo $donnees["nom"] ; ?> " class="form-control" id="exampleInputuname2">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail2">Le prenom</label>
                                        <div class="input-group">
                                            <input type="text" name="prenom" value="<?php echo $donnees["prenom"] ; ?> "class="form-control" id="exampleInputEmail2">
									...
									<div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="login" value="<?php echo $donnees["login"] ; ?> "class="form-control" id="exampleInputEmail2">
									 ...
									 <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="email" value="<?php echo $donnees["email"] ; ?> " class="form-control" id="exampleInputpwd2">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputpwd2">Date de naissance</label>
                                        <div class="input-group">
                                            <input type="text" name="date" value="<?php echo $donnees["date_naissance"] ; ?> " class="form-control" id="exampleInputpwd2">
                                            <span class="input-group-text"><i class="icon-calender"></i></span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputpwd3">Le role</label>
                                        <div class="input-group">
									<SELECT name="role" class="form-control" align="center" size="1" style="font-size: 10pt; border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">	
									<?php
											$req02 = $bdd->prepare('SELECT * FROM role ');
											$req02->execute() ;
											while ($donnees02 = $req02->fetch())
												{
											if ($donnees['role'] == ($donnees02['ID_role'] ))
											$selected= 'selected';
										else $selected='';
											?>
								
										<OPTION value="<?php echo $donnees02['ID_role'];?>" <?php echo $selected ;?>> <?php echo $donnees02['type']; ?></OPTION> 
										<?php } ?>					
								 </SELECT>			                                            
