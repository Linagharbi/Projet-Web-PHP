                        ...
                        <div class="card">
                            <div class="row">
                                ...
                                <div class="col-xlg-10 col-lg-9 col-md-8 bg-light-part b-l">
                                    <div class="card-body">
                                        <button type="button" class="btn btn-secondary m-r-10 m-b-10"><a href="corbeille.php"><i class="mdi mdi-reload font-18"></i></a></button>
                                            ...
                                            <div class="inbox-center table-responsive">
                                                <table class="table table-hover no-wrap">
													...
													<?php 
														...
														$rep = $bdd->query('SELECT * FROM message WHERE flag_arch= 1 AND  (id_dest='.$donnees1['ID_utilisateur'].')GROUP BY (ID_message) DESC ') ;
