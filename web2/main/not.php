                    ...
                    <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <div class="ribbon-wrapper card">
                                    <div class="ribbon ribbon-bookmark  ribbon-danger">Un Nouveau Projet</div>
                                    <p class="ribbon-content"><?php echo $donneesnn['nom'] ; ?></p>
                                </div>
                            </div>
										...
										$repnn1 = $bdd->query('SELECT * FROM tache WHERE flag_t=3 AND projet IN (SELECT ID_projet from projet WHERE user='.$id_user.')');
											...
											?>
										 <div align="left" class="col-lg-3 col-md-4 col-sm-3 col-xs-12">
                                <div class="ribbon-wrapper card">
                                    <div class="ribbon ribbon-bookmark  ribbon-warning">Une tâche est terminée</div>
                                    <p class="ribbon-content"><?php echo $donneesnn1['sujet'] ; ?></p>
                                </div>
                            </div>
														<?php }} ?>	
										...
										$repnv = $bdd->query('SELECT * FROM projet WHERE flag_pr=4 AND user='.$_SESSION['ID_utilisateur']) ;
											...
											?>
                                                        <div class="col-lg-3 col-md-4 col-sm-3 col-xs-12">
                                <div class="ribbon-wrapper card">
                                    <div class="ribbon ribbon-bookmark  ribbon-success">Un Projet est Validé</div>
                                    <p class="ribbon-content"><?php echo $donneesnv['nom'] ; ?></p>
                                </div>
                            </div>
										...
										$repnn7= $bdd->query('SELECT * FROM tache WHERE flag_t=1 AND utilisateur='.$_SESSION['ID_utilisateur']) ;
											...
											?>
                                                            <div class="col-lg-3 col-md-4 col-sm-3 col-xs-12">
                                <div class="ribbon-wrapper card">
                                    <div class="ribbon ribbon-bookmark  ribbon-danger">Une Nouvelle Tâche</div>
                                    <p class="ribbon-content"><?php echo $donneesnn7['sujet'] ; ?></p>
                                </div>
                            </div>
										...
										$repnv7 = $bdd->query('SELECT * FROM tache WHERE flag_t=4 AND utilisateur='.$_SESSION['ID_utilisateur']) ;
											...
											?>
                                                           <div class="col-lg-3 col-md-4 col-sm-3 col-xs-12">
                                <div class="ribbon-wrapper card">
                                    <div class="ribbon ribbon-bookmark  ribbon-success">Une tâche est Validée</div>
                                    <p class="ribbon-content"><?php echo $donneesnv7['sujet'] ; ?></p>
                                </div>
                            </div>
														<?php }} ?>	
								 ...
								 <div align="left" class="col-lg-3 col-md-4 col-sm-3 col-xs-12">
                                <div class="ribbon-wrapper card">
                                    <div class="ribbon ribbon-bookmark  ribbon-warning">Un Projet est Terminé</div>
                                    <p class="ribbon-content"><?php echo $donneesnn9['nom'] ; ?></p>
                                </div>
                            </div>
