...
if (isset($_GET['supp'])) 
{	$count=$bdd->prepare('DELETE FROM message WHERE ID_message='.$_GET['id'].'');
    $count->execute();	
}
                            ...
                            <div class="row">
                                <div class="col-xlg-2 col-lg-3 col-md-4">
                                    <div class="card-body inbox-panel"><a href="message.php" class="btn btn-danger m-b-20 p-10 btn-block waves-effect waves-light">Nouveau message</a>
										...
										?>
                                            <li class="list-group-item"> <a href="email.php"><i class="mdi mdi-gmail"></i> Boîte de réception </a><span class="badge badge-success ml-auto"><?php echo $donnees00['nbre'] ; ?> </span></li>
                                          <?php  ?>                                         
                                ...
                                <div class="col-xlg-10 col-lg-9 col-md-8 bg-light-part b-l">
                                    <div class="card-body">
                                        ...
                                        <button type="button" class="btn btn-secondary m-r-10 m-b-10"><a href="emailenv.php"><i class="mdi mdi-reload font-18"></i></a></button>
                                        ...
                                        <div class="card b-all shadow-none">
                                            <div class="inbox-center table-responsive">
                                                <table class="table table-hover no-wrap">
                                                    <tbody>
													<?php
													$rep = $bdd->query('SELECT * FROM message WHERE(id_exp='.$_SESSION['ID_utilisateur'].')GROUP BY (ID_message) DESC ') ;
													...
													?>
                                                        <tr class="unread">
														 <td style="width:40px"> 
															<?php 
															echo '<a href="emailenv.php?supp&id='.$donnees11["ID_message"].'">
                                                             <button type="button" class="btn btn-secondary font-18"><i class="mdi mdi-delete"></i></button></a>'; ?>
             
                                                            </td>
                                                           
															<?php  
																$rep1 = $bdd->query('SELECT * FROM utilisateur WHERE ID_utilisateur='.$donnees11['id_dest']) ;
															$donnees0 = $rep1->fetch();
															?>
                                                            <td class="hidden-xs-down"><?php echo $donnees0['prenom'] ; echo ' ' ; echo $donnees0['nom'] ;  ?></td>
                                                         
                                                         <td class="hidden-xs-down"><?php echo $donnees11['objet'] ;  ?></td>
