...
$reqa = $bdd->prepare('UPDATE message
 SET flag_lu= 1
 WHERE ID_message=?');	
  $reqa->execute(array(
     $_GET['id']
                            ...
                            <div class="row">
                                ...
                                <div class="col-xlg-10 col-lg-9 col-md-8 bg-light-part b-l">
                                    <div class="card-body">
                                        ...
                                        <button type="button" class="btn btn-secondary m-r-10 m-b-10"> <?php echo ' <a href="imp.php?id='.$id.'"><i class="ti-eye"></i></a> ' ; ?></button>
                                    ...
                                    <div class="card-body p-t-0">
                                        <div class="card b-all shadow-none">
											...
											$req = $bdd->query('SELECT * FROM message WHERE ID_message='.$id);

											$donnees = $req->fetch();
											{
												?>
											<div class="card-body">
												      <strong class="text-muted">Objet : <?php echo $donnees['objet'] ; ?> </strong>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex m-b-40">
                                                    ...
                                                    <div class="p-l-10">
													<?php  
																$rep1 = $bdd->query('SELECT * FROM utilisateur WHERE ID_utilisateur='.$donnees['id_exp']) ;
															$donnees0 = $rep1->fetch();
															?>
                                                       
                                                        <small class="text-muted">De : <?php echo $donnees0['email'] ; ?></small>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="b-all m-t-20 p-20">
                                                    <p class="p-b-20">Cliquez ici pour <?php echo '<a href="messagerep.php?id='.$donnees['id_exp'].'">'; ?> Répondre</a> or <?php echo '<a href="messagetr.php?id='.$donnees['ID_message'].'">'; ?>Transférer</a></p>
                                                </div>
                                            </div>
											<?php } ?>
                                        </div>
