...
session_start();
$reponse1 = $bdd->query('SELECT * FROM utilisateur WHERE ID_utilisateur='.$_SESSION['ID_utilisateur']); 
...
if (isset($_GET['supp']))
{	$count=$bdd->prepare('DELETE FROM projet WHERE ID_projet='.$_GET['id'].' ');
    $count->execute();	
}
?>
	<?php
								$reqp = $bdd->prepare('SELECT * FROM projet');
								$reqp->execute() ;
								while ($donneesp = $reqp->fetch())
								{ 
									 $reqc = $bdd->prepare('UPDATE projet
											SET flag_pr= 4
											WHERE statut="Validé"');	
											$reqc->execute(array($donneesp['statut'])); 
											
									
									$reqcc = $bdd->prepare('UPDATE projet
											SET flag_pr= 3
											WHERE statut="Terminé"');	
											$reqcc->execute(array($donneesp['statut'])); 
									
										$reqcd = $bdd->prepare('UPDATE projet
											SET flag_pr= 2
											WHERE statut="En Cours"');	
											$reqcd->execute(array($donneesp['statut'])); 
											
											$reqcn = $bdd->prepare('UPDATE projet
											SET flag_pr= 1
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Gestion de Projets</h3>
                </div>
					...
					<?php
						  ...
						  <td><?php echo $donnees['nom']; ?></td>
							...
							<?php 
								...
								$req2 = $bdd->prepare('SELECT * FROM utilisateur WHERE ID_utilisateur='.$donnees["user"].' ');
								$req2->execute() ;
							...
							<td>
						<?php 
						 echo '<a href="modifierprojet.php?id='.$donnees["ID_projet"].'">
						...
						<?php echo '<a href="taches.php?id='.$donnees["ID_projet"].'">
							<button type="button" class="btn btn-sm btn-icon btn-pure btn-outline check-row-btn" data-toggle="tooltip" data-original-title="Consulter Projet"><i class="ti-eye" aria-hidden="true"></i></button></a>'; ?>
						
							<?php echo '
								<a href="projets.php?supp&id='.$donnees["ID_projet"].'" onclick="return supprimer();">
						<button type="button" class="btn btn-sm btn-icon btn-pure btn-outline delete-row-btn" data-toggle="tooltip" data-original-title="Supprimer"><i class="ti-close" aria-hidden="true"></i></button>'; ?>

                                                </td>

							 </tr>
							<?php }} 
							elseif ($donnees1['role']=="2")
							{$req = $bdd->query('SELECT * FROM projet WHERE user='.$_SESSION['ID_utilisateur']);
						  ...
						  <td><?php echo $donnees['nom']; ?></td>
							...
							<td>
							<?php echo '<a href="modifierprojet.php?id='.$donnees["ID_projet"].'">
							<button type="button" class="btn btn-sm btn-icon btn-pure btn-outline marker-row-btn" data-toggle="tooltip" data-original-title="Modifier"><i class="ti-marker-alt" aria-hidden="true"></i></button></a>
						'; ?>
						<?php echo '<a href="taches.php?id='.$donnees["ID_projet"].'">
							<button type="button" class="btn btn-sm btn-icon btn-pure btn-outline check-row-btn" data-toggle="tooltip" data-original-title="Consulter Projet"><i class="ti-eye" aria-hidden="true"></i></button></a>'; ?>
							...
							<?php }} 
							elseif ($donnees1['role']=="3")
							{
							$req = $bdd->query('SELECT * FROM projet WHERE ID_projet IN ( SELECT projet from tache where utilisateur='.$_SESSION['ID_utilisateur'].')');
							while ($donnees = $req->fetch())
							{
							?>
						  <tr>
						  ...
						  <td><?php echo $donnees['nom']; ?></td>
							...
							<td>
							<?php
							echo '<a href="taches.php?id='.$donnees['ID_projet'].'">
							<button type="button" class="btn btn-sm btn-icon btn-pure btn-outline check-row-btn" data-toggle="tooltip" data-original-title="Consulter Tâche"><i class="ti-eye" aria-hidden="true"></i></button></a>';  ?>
						...
						if ($donnees1['role'] =="1" )
						{echo ' <td colspan="2">
                          <button type="button" class="btn btn-info btn-rounded" data-toggle="modal" data-target="#add-contact">Ajouter Projet</button>
						</td> ' ;} ?>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form class="form-material" method="post" action="saisieprojet.php" >
                                                                    <div class="form-group">
                                                                        <div class="form-group">
																		<font size="1"> 
																			<label><h6>Nom du projet</h6></label>
																			<div class="input-group">
																		<input type="text" name="nom" placeholder="Nom du projet"  class="form-control"  align="center" size="1" style="font-size: 10pt; border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px"> 
																		 ...
																		 <div class="form-group">
																		 <font size="1"> 
																			<label><h6>Date de début</h6></label>
																			<div class="input-group">
																		<input type="date" name="date1"  class="form-control"  align="center" size="1" style="font-size: 10pt; border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px"> 
                                                                        ...
                                                                        <div class="form-group">
																		 <font size="1"> 
																			...
																			<div class="input-group">
																		<input type="date" name="date2" class="form-control"  align="center" size="1" style="font-size: 10pt; border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px"> 
																				<span class="input-group-text"><i class="icon-calender"></i></span>
																			</div>
																			</font> 
																		</div>
																		 ...
																		 <font size="1"> 
																			...
																			<div class="input-group">
																		<input type="text" name="description" placeholder="Description"  class="form-control"  align="center" size="1" style="font-size: 10pt; border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px"> 
										...
										<OPTION> Nouveau </OPTION>
                                                ...
                                                <span class="input-group-text" id="basic-addon2">
                                                    <i class="ti-receipt"></i>
																		...
																		<label><h6> Le Responsable </h6></label>
																		<div class="input-group">
																			<SELECT name="user" class="form-control"   size="1" style="font-size: 10pt; border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">	
																				<?php
																			
								
																					$req4 = $bdd->prepare('SELECT * FROM utilisateur WHERE role="2" ');
																				$req4->execute() ;
																				while ($donnees4 = $req4->fetch())
																				{
																					?>
								
																			<OPTION value="<?php echo $donnees4['ID_utilisateur']; ?>"> <?php echo $donnees4['nom'];  echo ' '; echo $donnees4['prenom']; ?>
																				</OPTION> 
																				<?php } ?>
