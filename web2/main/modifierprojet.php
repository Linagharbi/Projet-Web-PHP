                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form p-t-20" action="modifierp.php" method="post">
										<?php
							
							$id =$_GET['id'] ;
							
				             $req2 = $bdd->query('SELECT * FROM projet WHERE ID_projet='.$id);
							...
							?>
									...
									<input type="hidden" name="id" value="<?php echo $donnees2["ID_projet"] ; ?>"></p>
									
                                    <div class="form-group">
                                        <label for="exampleInputuname2">Nom du projet</label>
                                        <div class="input-group">
                                    <input type="text" name="nom"  value="<?php echo $donnees2["nom"] ; ?>" class="form-control" id="exampleInputuname2" <?php if ($donnees1['role']== "2") echo "disabled"; ?>> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                    <input type="date" name="date1" <?php if ($donnees1['role'] == "2" ) echo "disabled"; ?> value="<?php echo $donnees2["date_debut"] ; ?>" class="form-control" id="exampleInputuname2"> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                    <input type="date" name="date2" <?php if ($donnees1['role'] == "2" ) echo "disabled"; ?>  value="<?php echo $donnees2["date_fin"] ; ?>" class="form-control" id="exampleInputuname2"> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                    <input type="text" name="description" <?php if ($donnees1['role'] == "2" ) echo "disabled"; ?> value="<?php echo $donnees2["description"] ; ?>" class="form-control" id="exampleInputuname2"> 
									...
									echo '<option> En Cours </option>
                                     ...
                                     <div class="form-group">
                                        <label for="exampleInputr">Responsable</label>
                                        <div class="input-group">
										<SELECT name="responsable" <?php if ($donnees1['role'] == "2" ) echo "disabled"; ?> class="form-control" align="center" size="1" style="font-size: 10pt; border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">	
								<?php
							
								
								$req = $bdd->prepare('SELECT * FROM utilisateur WHERE role="2"') ;
								$req->execute() ;
								while ($donnees = $req->fetch())
								{
								if ($donnees['ID_utilisateur'] == ($donnees2['user'] ))
								$selected= 'selected';
							   else $selected='';	
								?>
								
                                 <OPTION value="<?php echo $donnees['ID_utilisateur']; ?>" <?php echo $selected ;?> > <?php echo $donnees['nom']; echo ' ' ; echo $donnees['prenom']; ?></OPTION> 
								 <?php } ?>						
								 </SELECT>
                                    ...
                                    <div class="text-left">
									<?php 
									echo '<a href="modifierprojet.php?mod&id='.$donnees2['ID_projet'].'">
                                        <button type="submit" class="btn btn-success waves-effect waves-light m-r-10">Modifier</button></a> ' ; ?>
