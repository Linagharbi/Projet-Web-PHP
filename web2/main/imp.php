               ...
               <div class="row">
					...
					<?php
                        ...
                        <div class="card card-body printableArea">
                            <h3><b>Message</b> <span class="pull-right"><?php echo $donnees['date_env'] ; ?>  </span></h3>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="pull-left">
										...
										<?php  
															...
															$donnees0 = $rep1->fetch();
															?>
                                            <h3> &nbsp;<b class="text-muted">De :</b></h3>
                                            <p class="text-muted m-l-5"><?php echo $donnees0['email'] ; ?> </p>
                                        </address>
                                    </div>
                                ...
                                <div class="col-md-12">
									...
									<h3> &nbsp;<b class="text-muted">Objet :</b></h3>  <p class="text-muted m-l-5"><?php echo $donnees['objet'] ; ?> </p>
