                            ...
                            <div class="row">
                                <div class="col-xlg-2 col-lg-3 col-md-4">
                                    <div class="card-body inbox-panel"><a href="message.php" class="btn btn-danger m-b-20 p-10 btn-block waves-effect waves-light">Nouveau message</a>
										...
										<?php 
										$req00 = $bdd->prepare('SELECT COUNT(*) AS nbre FROM message WHERE flag_arch=0 AND id_dest='.$_SESSION['ID_utilisateur']);
											$req00->execute() ;
										...
										?>
                                          ...
                                          <?php  ?>
                                            ...
                                            <li class="list-group-item">
                                                <a href="corbeille.php"> <i class="mdi mdi-delete"></i> Corbeille </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-xlg-10 col-lg-9 col-md-8 bg-light-part b-l">
                                    <div class="card-body">
                                        <button type="button" class="btn btn-secondary m-r-10 m-b-10"><a href="email.php"><i class="mdi mdi-reload font-18"></i></a></button>
                                        <div class="btn-group m-b-10" role="group">
                                            <button id="btnGroupDrop1" type="button" class="btn m-b-10 btn-secondary font-18 dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Plus </button>
                                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1"> <?php echo ' <a class="dropdown-item" href="email.php?modd"> '; ?> Tout marquer comme lu</a>  </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="inbox-center table-responsive">
                                                <table class="table table-hover no-wrap">
													...
													<?php 
														...
														$rep = $bdd->query('SELECT * FROM message WHERE flag_arch= 0 AND (id_dest='.$donnees1['ID_utilisateur'].')GROUP BY (ID_message) DESC ') ;
														
														while ($donnees11 = $rep->fetch())
															{
														?>
                                                        <tr class="unread" <?php if ($donnees11['flag_lu']==0) {?> bgcolor="E8F8F5" <?php } ?>>
														
                                                            <td style="width:40px"> 
															<?php 
															echo '<a href="email.php?supp&id='.$donnees11["ID_message"].'">
                                                             <button type="button" class="btn btn-secondary font-18"><i class="mdi mdi-delete"></i></button></a>'; ?>
															...
															$donnees0 = $rep1->fetch();
															?>
                                                            <td class="hidden-xs-down"><?php echo '<a href="detail.php?mod&id='.$donnees11["ID_message"].'"/>' ; ?><?php echo $donnees0['prenom'] ; echo ' ' ; echo $donnees0['nom'] ;?></td>
                                                           <td class="text-right"><?php echo $donnees11['date_env'] ; ?> </td>
