                        ...
                        <div class="card">
                            <div class="row">
                                ...
                                <div class="col-xlg-10 col-lg-9 col-md-8 bg-light-part b-l">
								 <form action="contenu.php" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
								...
								?>
								 ...
								 <?php } ?>						
                                        ...
                                        <div class="form-group">
                                            <textarea name="sujet" class="textarea_editor form-control" rows="15" placeholder="Entrer texte ..."></textarea>
                                        </div>
                                      ...
                                      <div class="button-box">
                                        <button name="envoyer" type="submit" class="tst3 btn btn-success"><i class="fa fa-envelope-o"></i> Envoyer</button>
